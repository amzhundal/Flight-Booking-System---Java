...
public class AddFlightWindow extends JFrame implements ActionListener {
    ...
    private JTextField noOfSeatsText = new JTextField();
    private JTextField priceText = new JTextField();
    private JTextField maxPassengersText = new JTextField();
    ...
    private void initialize() {
        ...
        topPanel.add(noOfSeatsText);
        topPanel.add(new JLabel("Price : "));
        topPanel.add(priceText);
        topPanel.add(new JLabel("Maximum Number Of Seats: "));
        topPanel.add(maxPassengersText); 
    ...
    private void addBook() {
        try {
            ...
            int maxPassengers = Integer.parseInt(maxPassengersText.getText()); 
            
            // create and execute the AddFlight Command
            Command addFlight = new AddFlight(flightNumber, origin, destination, departureDate, noOfSeats, price, maxPassengers);
            ...
            new FlightBookingSystemException("Date must be in YYYY-DD-MM format");
        }
